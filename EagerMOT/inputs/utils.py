...
POINTGNN_DETS_DIR = MOUNT_PATH + os.path.join("..\\pointgnn\\", SPLIT)
...
SEGMENTATIONS_TRACKRCNN_DIR = os.path.join("..\\detections_segmentations_trackrcnn_BB2SegNet", SPLIT)
MOTSFUSION_RRC_DIR = os.path.join("..\\detections_segmentations_RRC_BB2SegNet\\", SPLIT)
MOTSFUSION_TRACKRCNN_DIR =  os.path.join("..\\detections_segmentations_trackrcnn_BB2SegNet\\", SPLIT)
...
DETECTIONS_MOTSFUSION_RRC_DIR = os.path.join(MOTSFUSION_RRC_DIR, "detections")
SEGMENTATIONS_MOTSFUSION_RRC_DIR = os.path.join(MOTSFUSION_RRC_DIR, "segmentations")
DETECTIONS_MOTSFUSION_TRACKRCNN_DIR = os.path.join(MOTSFUSION_TRACKRCNN_DIR, "detections_segmentations_trackrcnn")
SEGMENTATIONS_MOTSFUSION_TRACKRCNN_DIR = os.path.join(MOTSFUSION_TRACKRCNN_DIR, "segmentations_trackrcnn")
