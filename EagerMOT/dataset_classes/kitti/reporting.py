from typing import Optional, IO, Mapping, Any, Iterable, List, Dict
...
from dataset_classes.nuscenes.reporting import *

def write_to_mot_file(frame_name: str, predicted_instances: Iterable[FusedInstance],
                      mot_3d_file: IO,
                      mot_2d_from_3d_only_file: Optional[IO],
    ...
    add_results_to_submit(submission=submission,
                          frame_token=frame_name,
    ...
    json_file_name = mot_3d_file.name.replace("txt", "json")
