...
import os
import pdb
from typing import Optional, Dict, List, Set, Iterable, Sequence, IO, Tuple, Callable, Any
...
class MOTFrameKITTI(mot_frame.MOTFrame):
    ...
    def bbox_3d_from_nu(self, bbox_nu: Box, instance_id: int, world: bool = False) -> Optional[Bbox3d]:  # Box
        ...
        if bbox_class in kitti_classes.ALL_KITTI_CLASS_NAMES:
...
class MOTSequenceKITTI(mot_sequence.MOTSequence):
    def __init__(self, det_source: str, seg_source: str, split_dir: str, split: str,
        ...
        self.submission: Dict[str, Dict[str, Any]] = {"results": {}}
    ...
    def ego_transform_for_frame(self, frame_name: str) -> np.ndarray:
        ...
        return self.ego_motion_transforms[frame_int-1]
    ...
    def report_mot_results(self, frame_name: str, predicted_instances: Iterable[FusedInstance],
        ...
        reporting.write_to_mot_file(frame_name, predicted_instances, mot_3d_file, mot_2d_from_3d_only_file, self.submission)
